...
import com.tqxd.daemon.config.NotificationUtils;
import com.tqxd.daemon.receiver.NotificationClickReceiver;
import com.tqxd.daemon.utils.ServiceUtils;
...
public final class JobHandlerService extends JobService {
    ...
    public boolean onStartJob(JobParameters jobParameters) {
        if (!ServiceUtils.isServiceRunning(this.getApplicationContext(), "com.tqxd.daemon.service.LocalService") || !ServiceUtils.isRunningTaskExist(this.getApplicationContext(), this.getPackageName() + ":remote")) {
            this.startService(this);
        }
